        ...
        <Grid2 container spacing={6}>
            ...
            <Grid2 size={{ xl: 9, lg: 8, md: 7, sm: 6, xs: 12 }}>
                ...
                <Stack direction="row" sx={{ mt: 3 }} alignItems="center" spacing={2}>
                    <Button loading={status === "pendingAddItem" + product.id} variant="outlined" loadingPosition="start" startIcon={<AddShoppingCart />} onClick={() => dispatch(addItemToCart({ productId: product.id }))}>
                        Sepete Ekle
                    </Button>
